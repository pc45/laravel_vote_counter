    ...
    <div class="flex items-end justify-center min-h-screen">
        ...
        <div
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <p class="text-xs text-center text-gray-500 mt-5 leading-5 px-8">You have 1 hour to edit your idea from the time you created it</p>
                <form wire:submit.prevent="updateIdea" action="#" class="space-y-4 px-4 py-6" method="post">
                    <div>
                        <input wire:model.defer="title" x-ref="title" type="text" class="text-sm border-none w-full bg-gray-100 rounded-xl placeholder:gray-900 px-4 py-2" placeholder="Your Idea" required>
                        @error('title')
                    ...
                    <div>
                        <select wire:model.defer="category" name="category_add" id="category_add" class="bg-gray-100 text-sm border-none w-full rounded-xl px-4 py-2 border-none">
                    ...
                    <div>
                        <textarea wire:model.defer="description" class="w-full bg-gray-100 rounded-xl placeholder:gray-900 text-sm px-4 py-2 border-none" placeholder="Describe your idea" name="idea" id="idea" cols="30" rows="4" required></textarea>
                        @error('description')
                        <p class="text-red text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
