<div>
    <nav class="hidden md:flex items-center justify-between text-xs text-gray-400">
        ...
        <ul class="flex uppercase font-semibold space-x-10 border-b-4 pb-3 text-gray-400">
            <li><a wire:click.prevent="setStatus('Implemented')" href="#" class="border-b-4 pb-3 hover:border-blue @if ($status=='Implemented')border-blue text-gray-900 @endif ">Implemented (10)</a></li>
