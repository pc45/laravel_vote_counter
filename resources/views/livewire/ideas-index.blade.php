<div>
    <div class="filters flex flex-col md:flex-row md:space-x-6 space-y-3 md:space-y-0">
        ...
        <div class="w-full md:w-1/3">
            <select wire:model="filter" name="otherFilter" id="otherFilter" class="w-full rounded-xl px-4 py-2 border-none">
        ...
        <div class="w-full md: w-2/3 relative">
            ...
            <input wire:model="search" type="search" placeholder="Find an Idea" class="w-full placeholder-gray-900 rounded-xl bg-white px-4 py-2 pl-8 border-none">
