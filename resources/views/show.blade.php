<x-app-layout>
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        <div class="flex items-center space-x-4 ml-6">
            ...
            <div class=" relative">
                <button type="button" class="w-32 flex items-center justify-center h-11 text-sm bg-blue font-semibold rounded-xl border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 text-white">
                    Reply
                </button>

                <div class="hidden absolute z-10 w-104 text-semibold text-left bg-white shadow-dialogue mt-2 rounded-xl">
                    <form action="#" class="space-y-4 px-4 py-6">
                        ...
                        <div class="flex items-center space-x-3">
                            <button type="button" class="w-1/2 flex items-center justify-center h-11 text-sm bg-blue font-semibold rounded-xl border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 text-white">
                                Post Comment
                            </button>

                            <button type="button" class="flex items-center justify-center w-32 h-11 text-xs bg-gray-200 font-semibold rounded-xl border hover:border-gray-400 transition duration-150 ease-in px-6 py-3">
            ...
            <div class="relative">
                <button type="button" class="flex items-center justify-center w-36 h-11 text-sm bg-gray-200 font-semibold rounded-xl border hover:border-gray-400 transition duration-150 ease-in px-6 py-3">
                ...
                <div class="absolute z-20 w-76 text-semibold text-left bg-white shadow-dialogue mt-2 rounded-xl">
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
