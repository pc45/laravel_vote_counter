        ...
        <div
            ...
            <div class=" relative">
                ...
                <div
                    ...
                    class="absolute z-10 w-104 text-semibold text-left bg-white shadow-dialogue mt-2 rounded-xl">
            ...
            <div
                ...
                <button
                    @click="isOpen = !isOpen"
                    type="button" class="flex items-center justify-center w-36 h-11 text-sm bg-gray-200 font-semibold rounded-xl border hover:border-gray-400 transition duration-150 ease-in px-6 py-3">
                ...
                <div
                    ...
                    @click.away="isOpen = false"
                    @keydown.escape.window = "isOpen = false"
                    class="absolute z-20 w-76 text-semibold text-left bg-white shadow-dialogue mt-2 rounded-xl">
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
                ...
                <div class="w-full mx-4">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div
                            ...
                            <button
                                @click="isOpen = !isOpen"
                                class="hidden relative bg-gray-100 hover:bg-gray-200 rounded-full h-7 w-14 border transition duration-150 ease-in py-2 px-4">
                                <svg fill="currentColor" width="24" height="6"><path d="M2.97.061A2.969 2.969 0 000 3.031 2.968 2.968 0 002.97 6a2.97 2.97 0 100-5.94zm9.184 0a2.97 2.97 0 100 5.939 2.97 2.97 0 100-5.939zm8.877 0a2.97 2.97 0 10-.003 5.94A2.97 2.97 0 0021.03.06z">
                                        <ul
                                            x-cloak
                                            x-show.transition.origin.top.left="isOpen"
                                            @click.away="isOpen = false"
                                            @keydown.escape.window = "isOpen = false"
                                            class="text-left absolute w-44 font-semibold bg-white shadow-dialogue rounded-xl py-3 ml-8">
                                            <li><a href="" class="hover:bg-gray-100 px-5 py-3 transition duration-150 ease-in block">Mark as spam</a></li>
                                            <li><a href="" class="hover:bg-gray-100 px-5 py-3 transition duration-150 ease-in">Delete Post</a></li>
                                        </ul>
                            </button>
